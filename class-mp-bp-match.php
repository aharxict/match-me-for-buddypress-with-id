...
class Mp_BP_Match {
  ...
  */
  function mp_bp_match_init() {
      ...
      add_shortcode( 'mp_match_with_id', array($this, 'mp_match_percentage_function_with_id'));
  ...
  */
  function mp_match_percentage_function() {
    ...
    function mp_match_percentage_function_with_id($atts) {
        $atts = shortcode_atts( array(
            'id' => 438
        ), $atts );
        $this->hmk_show_matching_percentage($atts['id']);
  ...
  */
  function hmk_get_matching_percentage_number( $user_displayed = '' , $user_logged_in = '', $own_id = '' ) {
  ...
  */
  function hmk_show_matching_percentage($own_id = '') {

    // if(bp_is_my_profile()) return;

  	echo '<div class="c100 p'.$this->hmk_get_matching_percentage_number('','',$own_id).' small hmk-percentage blue">
  		<span class="hmk-match-inside">Match</span>
  		<span>'.$this->hmk_get_matching_percentage_number('','',$own_id).'%</span>
  		<div class="slice">
  			<div class="bar"></div>
  			<div class="fill"></div>
  		</div>
